...

{
    programs.bash = {
        ...
        # --------------------------
        alias nos-new='cd ~/.nix-config/nixos-25.05 && sudo nixos-rebuild switch --flake .#myhost'
        alias nos-update='cd ~/.nix-config/nixos-25.05 && nix flake update --flake .'
        alias nos-upgrade='cd ~/.nix-config/nixos-25.05 && sudo nixos-rebuild switch --upgrade --flake .#myhost'
        alias nos-check='cd ~/.nix-config/nixos-25.05 && nixos-rebuild build --flake .#myhost'
        ...
        # --------------------------
        alias own-flake='sudo chown querzion:users /home/querzion/.nix-config/nixos-25.05/flake.lock'
